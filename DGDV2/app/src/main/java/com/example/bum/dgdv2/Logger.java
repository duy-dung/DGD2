...
public class Logger {
    ...
    public static void d(String pMsg) {
        if (DEBUG) {
            Log.d(TAG, String.format("%-30s : %-30s : %-5s : ", getClassName(), getMethodName(),
                    getLineNumber()) + pMsg);
        }
    }
    ...
    public static void e(String pMsg) {
        if (DEBUG) {
            Log.e(TAG, String.format("%-30s : %-30s : %-5s : ", getClassName(), getMethodName(),
                    getLineNumber()) + pMsg);
        }
    }
    ...
    public static void v(String pMsg) {
        if (DEBUG) {
            Log.v(TAG, String.format("%-30s : %-30s : %-5s : ", getClassName(), getMethodName(),
                    getLineNumber()) + pMsg);
        }
    }
